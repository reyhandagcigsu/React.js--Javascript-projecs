...
const switchPlayer = function () {
  ...
  currentScore = 0;
  activePlayer = activePlayer === 0 ? 1 : 0; // turnary operator denir.
...
btnRoll.addEventListener("click", function (e) {
  if (playing) {
    ...
    // check from rolled 1 : if true swich to next player
    if (dice !== 1) {
...
btnNew.addEventListener("click", init);  // do not call this funct. 
